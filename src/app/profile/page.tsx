...
export default async function ProfilePage({ params }: { params?: { userId?: string } }) {
  ...
  if (!isOwnProfile && session.user.user_metadata?.role !== "recruiter" && session.user.user_metadata?.role !== "admin") {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-6">
        {isOwnProfile ? "Your Profile" : `${profile?.firstname} ${profile?.lastname}'s Profile`}
      </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col space-y-2">
                {profile.portfolio_url && (
                  <a href={profile.portfolio_url} target="_blank" rel="noopener noreferrer" className="text-black-600 hover:underline">
                    Portfolio
                  </a>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {profile.education && profile.education.length > 0 && (
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    {profile.education.map((edu: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined, index: Key | null | undefined) => (
                      <li key={index}>{edu}</li>
                    ))}
                  </ul>
                </div>
              ...
              {profile.experience && profile.experience.length > 0 && (
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    {profile.experience.map((exp: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined, index: Key | null | undefined) => (
                      <li key={index}>{exp}</li>
                    ))}
                  </ul>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.skills.map((skill: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined, index: Key | null | undefined) => (
                    <span key={index} className="px-3 py-1 bg-blue-100 rounded-full text-blue-800">
                      {skill}
                    </span>
                  ))}
                </div>
